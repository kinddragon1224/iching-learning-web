    ...
    <html lang="ko">
      <body className={`${notoSansKr.variable} ${notoSerifKr.variable} ${geistMono.variable} antialiased`}>
        <nav className="fixed inset-x-0 top-0 z-[100] px-3 pt-2">
          <div className="mx-auto flex max-w-4xl items-center gap-2 rounded-xl border border-white/20 bg-black/65 p-2 backdrop-blur">
            ...
            <details className="ml-auto relative">
              ...
              <div className="absolute right-0 mt-2 w-48 rounded-xl border border-white/20 bg-black/90 p-2 shadow-xl">
