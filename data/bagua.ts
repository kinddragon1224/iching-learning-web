...
export const BAGUA_ITEMS: BaguaItem[] = [
  {
    ...
    shuoGuaSymbols: ["天", "圜", "君", "父", "首", "馬", "良馬", "老馬", "瘠馬", "駮馬", "玉", "金", "寒", "冰", "大赤", "木果"],
  ...
  },
  {
    ...
    shuoGuaSymbols: ["地", "母", "腹", "牛", "子母牛", "布", "釜", "吝嗇", "均", "大輿", "文", "眾", "柄", "黑"],
  ...
  },
  {
    ...
    shuoGuaSymbols: ["雷", "長男", "足", "龍", "動", "玄黃", "大塗", "決躁", "蒼筤竹", "萑葦", "馬(善鳴·馵足·作足·的顙)", "反生", "健", "蕃鮮"],
  ...
  },
  {
    ...
    shuoGuaSymbols: ["風", "木", "長女", "股", "雞", "入", "繩直", "工", "白", "長", "高", "進退", "不果", "臭", "寡髮", "廣顙", "多白眼", "近利市三倍", "躁卦"],
  ...
  },
  {
    ...
    shuoGuaSymbols: ["水", "中男", "耳", "豕", "陷", "溝瀆", "隱伏", "矯輮", "弓輪", "加憂", "心病", "耳痛", "血卦", "赤", "馬(美脊·亟心·下首·薄蹄·曳)", "輿(多眚)", "月", "盜", "木(堅多心)"],
  ...
  },
  {
    ...
    shuoGuaSymbols: ["火", "日", "電", "中女", "目", "雉", "麗", "甲冑", "戈兵", "大腹", "鼈", "蟹", "蠃", "蚌", "龜", "木(科上槁)"],
  ...
  },
  {
    ...
    shuoGuaSymbols: ["山", "少男", "手", "狗", "止", "徑路", "小石", "門闕", "果蓏", "閽寺", "指", "鼠", "黔喙之屬", "木(堅多節)"],
  ...
  },
  {
    ...
    shuoGuaSymbols: ["澤", "少女", "口", "羊", "說", "巫", "口舌", "毀折", "附決", "剛鹵", "妾"],
